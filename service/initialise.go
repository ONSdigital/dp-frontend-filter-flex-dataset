...
func (e *ExternalServiceList) GetRendererClient(rendererURL string) *renderer.Renderer {
...
func (e *Init) DoGetRendererClient(rendererURL string) *renderer.Renderer {
	return renderer.New(rendererURL)
}
